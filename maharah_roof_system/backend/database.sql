...
INSERT INTO users (username, password, full_name, role, can_make_sales, can_view_inventory, can_edit_inventory, can_view_order_details, can_cancel_orders, can_edit_orders, can_view_reports, can_add_expenses, can_manage_offers)
VALUES ('admin', '$2a$10$xQZ7zYZ5Z5Z5Z5Z5Z5Z5Z.Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5Ze', 'System Administrator', 'admin', TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE);
-- Note: The password hash above is just a placeholder. It will be properly hashed when creating users through the API
